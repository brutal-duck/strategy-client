...
export default class SuperHexConfirm {
  ...
  private createElements(): void {
    ...
    this.top = this.scene.add.sprite(x, y - 100, 'header-lil').setOrigin(0.5, 0);
    ...
    this.btn2 = new ColorsBtn(this.scene, { x: x + 64, y: midGeom.centerY + 45 }, (): void => { 
